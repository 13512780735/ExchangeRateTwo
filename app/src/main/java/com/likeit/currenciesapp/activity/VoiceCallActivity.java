...
//
//        MyApplication.isVoiceCalling = true;
//		callType = 0;
//
...
//
//        EaseUser easeUser=MyApplication.getInstall().getEaseUser(username);
//        if(easeUser!=null){
//            nickTextView2.setText(easeUser.getNickname());
//            Glide.with(this).load(easeUser.getAvatar()).into(swing_card);
//        }else{
...
//                        EaseUser easeUser=new EaseUser(httpResult.getInfo().getRongcloud());
//                        easeUser.setNickname(httpResult.getInfo().getTruename());
//                        easeUser.setAvatar(MyApiService.IMG_BASE_URL+httpResult.getInfo().getPic());
//                        MyApplication.getInstall().putEaseUser(username,easeUser);
...
//    public void updateUserInfo(RefreshEvent event) {
//        if (event.getType() == RefreshEvent.GET_USER_INFO) {
//            EaseUser easeUser=MyApplication.getInstall().getEaseUser(username);
//            if(easeUser!=null){
//                nickTextView2.setText(easeUser.getNickname());
//                Glide.with(this).load(easeUser.getAvatar()).into(swing_card);
...
//        MyApplication.isVoiceCalling = false;
//        stopMonitor();
//        super.onDestroy();
//    }
//
