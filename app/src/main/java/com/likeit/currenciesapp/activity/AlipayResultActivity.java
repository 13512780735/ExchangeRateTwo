...
public class AlipayResultActivity extends RateInfoBaseActivity {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                switch (checkedId) {
                    ...
                    case R.id.btn_wechat:
                        ...
                        inputBankAccountEt.setHint("請輸入微信錢包賬號");
                        break;
                }
    ...
    private void initTopCommInfo() {
        ...
        if(!TextUtils.isEmpty(alipayGive)&&!TextUtils.equals("0",alipayGive)){
            tx31.setText("實付新台幣金額:" + realGet + "  " + formula+" (赠送:"+alipayGive+"人民幣)");
                ...
                tipsDialog.setOnClickListener(new TipsDialog.OnClickListener() {
                    ...
                    public void onLeftClick() {
                        if (modifyOrder) {
                            ...
                            HttpMethods.getInstance().do_order(myRateInfoSubscriber, uKey, "3", nowCoinId, "1", inputValue, "", bz, orderBeforeId, bankAccount, passwd, bankName, "", "", "", "", "", pty);
                        }
                    }
